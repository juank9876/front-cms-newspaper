    ...
    <li className={hasSubcategories ? 'group relative' : ''}>
      <NavigationMenuLink asChild>
        <Link
          ...
          className={`flex items-start px-4 py-2 text-base font-normal uppercase tracking-wide text-slate-900 hover:underline hover:underline-offset-8 transition-colors duration-150 ${isChild ? 'pl-8 text-sm' : ''}`}
        >
          {title}
          {hasSubcategories && (
